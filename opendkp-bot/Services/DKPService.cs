...
namespace opendkp_bot.Services
{
    class DKPService
    {
        ...
        private static string DKP_URL = "https://4jmtrkwc86.execute-api.us-east-2.amazonaws.com/beta/client/imperfekt";
        private static string ClientId = "yGzZHVwQpk+AriLrcvi3+w==";
